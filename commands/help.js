...
.addField('*anihelp', 'to get anime commands', true)
.addField('*music', 'to get music commands', true)
.addField('*whois', "to get someone's stats", true)
.addField('*serverinfo', 'to get serverinfo', true)
.addField('*warn', 'to warn someone', true)
.addField('*warnings', "to get someone's warning count", true)
.addField('*resetwarns', 'to reset the count of warnings of a person', true)
